...
import 'package:pfe/components/task_tile.dart';
import 'package:pfe/models/planning.dart';
import 'package:pfe/models/population.dart';
import 'package:pfe/screens/planning/updatePlanning.dart';
...
import '../../destests/timeline.dart';
import 'add_task_super.dart';
import 'add_task_user.dart';
...
class _CalendarPageState extends State<CalendarPage> {
              ...
              child: SfCalendar(
                ...
                allowedViews: const [
                  ...
                  if (details.appointments!.isNotEmpty) {
                    ...
                    alerte(details.appointments![0].id,
  ...
  alerte(int _id, name) async {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
              ...
              title: Column(children: [Text('Task : $name')]),
        ...
        context,
        MaterialPageRoute(
          builder: (context) => UpdateTaskPage(id: _id),
        ),
      ); 
                  }),
                  child: Row(children: [
    ...
    //    child: FlatButton(onPressed: (() => delete(_id)), child:const Text("Delete") ,)) ,Container(
    //    height: 50,
    //    width: 120,
    //    decoration: BoxDecoration(
    //        color:const Color.fromARGB(255, 0, 255, 42),
    //        borderRadius: BorderRadius.circular(30)),
    //    child: FlatButton(onPressed: (() => onbutton(_id )), child: Text("Update") ,) )],)  ,
    // );
  }
  ...
  Future<void> onbutton(int _id) async {
    ...
    http.Response response = await CallApi().getData('getplannings/$_id');
    var json = jsonDecode(response.body);
    var plannigEdit = Planning.fromJson(json);

    activity = TextEditingController(text: plannigEdit.activity.toString());
  ...
  void update(int _id, Planning plannings) async {
    ...
    //     List iduser = lesuser
    //       .where((lesuser) =>
    //           lesuser.firstname == user.text.split(' ')[0] && lesuser.lastname == user.text.split(' ')[1])
    //       .toList();
    //   user_id = iduser[0].id;
    //  }
    //  int? activite_id  ;
